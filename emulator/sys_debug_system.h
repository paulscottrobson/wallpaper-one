...
#define WIN_WIDTH		(32*6*4+32)
#define WIN_HEIGHT		(23*8*4+32)
...
#define DEBUG_HOMEPC()		(CPUGetStatus()->p0+1) 									// Get PC Home Address (e.g. current PCTR value)
...
#define DEBUG_RAMSTART 		(0x0C00)												// Initial RAM address for debugger.
